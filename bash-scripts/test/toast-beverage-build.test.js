...
const {beer,liquor}=buildBeverageRows([
 ...
 {item_name:'Guinness Imperial',price:'10.00',category:'DRAFT IMP PINT'},
 {item_name:'Modelo Can',price:'7.00',category:'BEER CAN'},
...
assert.equal(liquor[0].liquor_type,'BOURB WHISK');
