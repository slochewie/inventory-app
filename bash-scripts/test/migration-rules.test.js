...
const result = applyMigrationRules([
  ...
  { item_name: 'Jameson', category: 'BOURBON/WHISKEY', plu: '2' },
  { item_name: 'Guinness Pint', category: 'DRAFT REG PINT', plu: '3' },
  { item_name: 'Guinness 10oz', category: 'DRAFT 10OZ', plu: '4' },
  { item_name: 'Guinness Imperial', category: 'DRAFT IMPERIAL PINT', plu: '5' },
...
assert.equal(result.held.find((row) => row.item_name === 'Old Fashioned').migration_action, 'excluded');
