...
function main(){
 ...
 fs.writeFileSync(beerOutput,stringifyCsv([['Beer Name','Draft 10 oz Price','Draft 16 oz Price','Can Price','Obsolete 20 oz Price (Review Only)'],...beer.map(r=>[r.item_name,r.draft_10oz_price,r.draft_16oz_price,r.can_price,r.obsolete_20oz_price])]));
