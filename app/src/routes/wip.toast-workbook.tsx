// Frozen unauthenticated manager route. Do not add Better Auth or database dependencies here.
import { createFileRoute } from '@tanstack/react-router'
import { type ChangeEvent, useEffect, useMemo, useState } from 'react'
import { WipInventorySidebar } from '#/wip-inventory-sidebar'
...
function ToastWorkbook() {
  ...
  return (
    <main className="inventory-shell">
      <WipInventorySidebar currentPath="/wip/toast-workbook" />
        ...
        <section className="inventory-card inventory-import-card">
          <div>
            ...
            {reviewSource === 'saved' ? (
              ...
              <p>No reviewed state found yet. Upload toast-export-review.csv or go to the WIP Menu Items page to review the Aloha CSV.</p>
            )}
          </div>
